...
**TankMark** is an intelligent raid marking automation addon for Vanilla WoW (1.12.1). It automates Raid Target assignment based on priority and includes tools for data collection and team coordination.
...
- **Combat Gating:** Scanner only marks mobs actively targeting raid members (SuperWoW)
...
- **Position Memory:** HUD remembers position per-character (v0.22)
- **Auto-Hide:** HUD hides when leaving party/raid (v0.22)
...
**Full command list:** Type `/tmark` in-game
...
**v0.20** - Zone caching, snapshot system, corruption detection
