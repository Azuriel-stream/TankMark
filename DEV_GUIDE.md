...
- `*_spec.lua` — `incumbency_spec` (the pure `IncumbencyBlocks` predicate),
  ...
  slice-4 `P`/`PR`/`planVersion` types **and [slice 5a.1] the `H` handoff type**),
  ...
  the `EvaluatePull` triple predicate, push-on-promotion).
