...
local function CreateMobEditorControls(editor)
	...
	local nameBox = TankMark:CreateEditBox(editor, "", 180)
	nameBox:SetPoint("TOPLEFT", 4, -6)
    ...
    targetBtn:SetPoint("TOPLEFT", 190, -6)
    ...
    prioBox:SetPoint("TOPLEFT", 35, -33)
    prioBox:SetText("1")
