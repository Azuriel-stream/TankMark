...
TankMark.DebugEnabled = false  -- Toggle with /tmark debug on/off
...
-- decision entries you actually want to capture. Set via "/tmark debug only <cats..>",
-- cleared via "/tmark debug all". Runtime-only (resets on /reload, like DebugEnabled).
